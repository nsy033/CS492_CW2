...
class ACGAN(object):
    ...
    def build_model(self):
        ...
        with tf.control_dependencies(tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.UPDATE_OPS)):
            ...
            self.q_optim = tf.compat.v1.train.AdamOptimizer(self.learning_rate * 5, beta1=self.beta1) \
        ...
        q_loss_sum = tf.compat.v1.summary.scalar("g_loss", self.q_loss)
        q_real_sum = tf.compat.v1.summary.scalar("q_real_loss", q_real_loss)
        q_fake_sum = tf.compat.v1.summary.scalar("q_fake_loss", q_fake_loss)
        ...
        self.q_sum = tf.compat.v1.summary.merge([q_loss_sum, q_real_sum, q_fake_sum])
